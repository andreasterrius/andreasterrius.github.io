...
In [SDF exploration pt 1](./2024-07-21-sdf-exploration-pt-1.md), I mentioned that using dot(faceNormal, sdfPoint) doesn't work that well to determine the sign of the SDF. 
